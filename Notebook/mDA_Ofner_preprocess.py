...
#dispersion_2 = 1000
#dispersion_3 = 500
selected_events = {'rest': 13, 'right_elbow_extension': 14, 'right_elbow_flexion': 15, 'right_hand_close': 16, 'right_hand_open': 17, 'right_pronation': 18, 'right_supination': 19}
min_duration = tmax
...
print("Save epoched data to epoch_data. Execute mDA_Ofner.ipynb to show the analysis.")
