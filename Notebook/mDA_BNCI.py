...
align_methods = ['rpa-5', 'rpa-6', 'rpa-7', 'rpa-8', 'rpa-9', 'rpa-10', 'rpa-200']
...
for scenario in cv_list.keys():
    for algo in overall_acc[scenario][align_methods[0]]:
        ...
        ax.set_yticklabels(['mRPA-{5}', 'mRPA-{6}', 'mRPA-{7}', 'mRPA-{8}', 'mRPA-{9}', 'mRPA-{10}', 'RPA'], fontsize=12)
        ax.set_xlabel('Classification accuracy', fontsize=12)
        plt.grid()
        plt.savefig(f"BNCI_w_k_{scenario}_{algo}.pdf", bbox_inches='tight')
        plt.show()
